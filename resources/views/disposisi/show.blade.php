    ...
    <div class="row mb-4 align-items-center">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <a href="{{ route('surat-masuk') }}" class="btn btn-outline-secondary btn-sm">
                    <i class="bi bi-arrow-left"></i> Kembali
                </a>
                <a href="{{ route('surat-masuk.print', $surat->id) }}" target="_blank" class="btn btn-light btn-sm shadow-sm text-dark border">
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0 opacity-75">Sistem Informasi Persuratan & Disposisi Digital</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <h6 class="fw-bold text-success">Surat Masuk Diterima</h6>
                                ...
                                <div class="alert alert-light border mb-0">
                                    <small class="text-dark">Surat telah diterima dan diinput ke dalam sistem oleh <strong>Admin Tata Usaha</strong>.</small>
                                </div>
                            </div>
                        </div>
...
@else
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="mt-3">
                                    <form action="{{ route('disposisi.finish', $surat->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menandai surat ini sebagai SELESAI?');">
                                        @csrf
                                    ...
                                    <div class="mt-2 text-center">
                                        <small class="text-muted">Atau buat Surat Keluar sebagai tindak lanjut:</small>
                                        <a href="{{ route('surat-keluar.create') }}" class="btn btn-outline-dark btn-sm w-100 mt-1"><i class="bi bi-envelope-plus me-2"></i> Buat Surat Keluar</a>
                                    </div>
                                </div>
                                @endif
                            </div>
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="card border-warning mt-3 shadow-sm">
                                    ...
                                    <div class="card-body bg-white">
                                        <form action="{{ route('disposisi.store', $surat->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-12">
                                                        <label class="small text-muted">Buat Tanda Tangan Digital</label>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <table class="table table-borderless table-sm mb-0">
                        <tr>
                            <td class="text-muted w-35 small text-uppercase fw-bold">No Agenda</td>
                            <td class="fw-bold text-dark">{{ $surat->no_agenda ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="text-muted small text-uppercase fw-bold">No Surat</td>
                            <td class="fw-bold text-dark">{{ $surat->no_surat }}</td>
                        </tr>
                        <tr>
                            <td class="text-muted small text-uppercase fw-bold">Pengirim</td>
                            <td class="fw-bold text-dark">{{ $surat->pengirim }}</td>
                        </tr>
                        <tr>
                            <td class="text-muted small text-uppercase fw-bold">Tgl Surat</td>
                            <td class="text-dark">{{ $surat->tgl_surat ? \Carbon\Carbon::parse($surat->tgl_surat)->format('d M Y') : '-' }}</td>
                        </tr>
                        <tr>
                            <td class="text-muted small text-uppercase fw-bold">Tgl Terima</td>
                            <td class="text-dark">{{ \Carbon\Carbon::parse($surat->tgl_terima)->format('d M Y') }}</td>
                        </tr>
                        <tr>
                    ...
                    <div class="d-grid">
                        @if($surat->file_path)
                        <a href="{{ route('surat-masuk.file', $surat->id) }}" target="_blank" class="btn btn-outline-danger shadow-sm py-2">
